...
import StepperLabel from './CreatePortfolioSteps/StepperLabel';
import HorizontalLinearStepper from './CreatePortfolioSteps/StepperLabel';
                        ...
                        <Grid container spacing={3} direction="column" justifyContent="center">
                            ...
                            <Grid item minHeight={100} container spacing={2} justifyContent="space-between">
                                <Grid item xs={6}>
                                    ...
                                    <TextField id="outlined-basic" value="Portfolio 1" variant="outlined" style={{ width: "80%" }} />
                                </Grid>
                                <Grid item xs={6}>
